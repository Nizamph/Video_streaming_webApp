...
const VideoCards = ({ videos }) => {
  ...
  return (
    <div
      className={`group relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-2xl hover:shadow-neon hover:scale-105 transition-all duration-300 ease-in-out overflow-hidden`}
    >
